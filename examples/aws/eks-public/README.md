...
This will walk you through the full deployment process, check your prerequisites, and help you configure variables. You can also jump to a specific step (e.g., `/deploy-aws-eks traefik` or `/deploy-aws-eks register`).
