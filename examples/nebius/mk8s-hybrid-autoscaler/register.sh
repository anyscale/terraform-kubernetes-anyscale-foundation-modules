...
echo ""
echo "📋 Next steps:"
echo "   1. Get the cloud deployment ID from Anyscale console:"
echo "      https://console.anyscale.com/o/anyscale-internal/clouds"
echo "   2. Update config.yaml with:"
echo "        anyscale:"
echo "          cloud_deployment_id: \"cldrsrc_xxxxx\""
echo "   3. Get an API token from:"
echo "      https://console.anyscale.com/o/anyscale-internal/credentials/cli-tokens"
echo "   4. Update config.yaml with:"
echo "        anyscale:"
echo "          cli_token: \"aph0_xxxxx\""
echo "   5. Deploy the cluster: cd deploy && terraform apply"
echo ""
